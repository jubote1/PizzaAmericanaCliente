...
public class BackgroundSalidaDomicilios extends AsyncTask <String, Void,String> {

    AlertDialog dialog;
    Context context;
    public Boolean login = false;
    public BackgroundSalidaDomicilios(Context context)
    {
    ...
    protected String doInBackground(String... voids) {
        ...
        String connstr = "http://" +urlServicios+"/ProyectoTiendaAmericana/DarSalidaDomicilios";
